...
const EventsSvg = () => (
  <svg width="180" height="180" viewBox="0 0 435 444" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <image href="/Discover.svg" x="345" y="8" width="50" height="50" filter="url(#fish-mono)" />
    {/* Pillar body */}
    ...
    <image href="/Navigate.svg" x="193" y="117" width="50" height="50" filter="url(#fish-mono)" />
    {/* Pillar body */}
    ...
    <image href="/Train.svg" x="40" y="246" width="50" height="50" filter="url(#fish-mono)" />
    {/* Pillar body */}
